const instructionDetails = {
  ...
  ASSESSMENT_INVITATION_SENT:
    "The assessment invitation was sent to the email address",
  ...
  TO_TAKE_SAMPLE: "to take our sample assessment. Please use password:",
  SAMPLE: "sample",
  SAMPLE_PROCEED: "to proceed.",
  CURRENTLY_TAKING: "You are currently taking this Assessent. Go to",
  ALL_PROBLEMS: " All problems /",
  DOSELECT_INSTR: " DoSelect instructions /",
  ...
  IMAGE_VERIFY:
    " Thank you! Please give us a moment. The image is being verified... ",
  IDENTITY_ERROR:
    "Image verification failed! Please try again...  The captured image does not meet the set standards. Please ensure the following while taking the image.",
  CHECKBOX_TXT:
  ...
  PROCTOR_MODE: "PROCTOR MODE",
  PROCTOR_MODE_SWITCH: "Proctor Mode : ON",
  VIDEO_CAPTURED: "Your video has been captured",
  ...
  REJECTED: "REJECTED",
  REVIEW: "REVIEW",
  FEATURE_NOT_SUPPORTED: "Your browser not support this feature",
  DEFAULT_SPEAK: "Default speakers",
  DEFAULT_MIC: "Default microphone",
  DEFAULT_CAM: "Default camera",
  WEBCAM_BLOCKED:
    " Your browser is blocking the webcam. Please enable the webcam from your browser settings and try again.",
  TEST_URL:
